...
<div class="container">
    ...
    <form action="" method="post">
        ...
        <div class="form-group">
            ...
            <input type="date" name="tgllhir" class="form-control" required>
        </div>
...
if(isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($con, "INSERT INTO mahasiswa(nim,nama,jkel,alamat,tgllhir) VALUES('$nim','$nama', '$jkel','$alamat','$tgllhir')");
